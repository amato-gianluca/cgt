"""
This script reads data for the counts_old.json file and produces a table in markdown format with the
results of the experiment relative to counting the number of games without Nash stable coalition
structures, with varying values for k, n (number of agents) power of twos as valuations.
