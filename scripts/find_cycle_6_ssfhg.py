"""
This script finds a cycle in the dynamic of a specific 6-SSFH game presented in the paper.

It also checks if there is coalition structures from which it is impossible to reach an equilibrium.
Note that this last check is extremely time consumign (several days are required) and produce no
results: from every coalition structure it is possible to reach an equilibrium.
"""
